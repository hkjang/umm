...
- **버린 선택지가 현재 방침처럼 읽히지 않습니다**: 시도해 본 방향에 이름을 붙이고 채택/접어 둠으로 정리하면, 검색·`/ai/ask`·조력자 어디에 나타나도 접어 둔 것임이 표시됩니다. 연결을 따라 도달한 생각도 포함합니다.
- **정리하려면 이유가 필요합니다**: 이유 없이 접어 둔 갈래는 결정만 남고 까닭은 사라지는, 이 기능이 막으려던 바로 그 망각입니다.
- **실측으로 확인한 차이**: 같은 질문에 갈래 전에는 "직접 통제할 수 있게 됩니다", 접어 둔 뒤에는 "플러그인 호환성 부담이 커서 채택하지 않기로 결정했습니다".
- **표시 문구가 반대로 읽힌 결함을 실제 모델에서 잡았습니다**: `[보류된 갈래]`를 모델이 "아직 결정 안 됨"으로 읽었습니다. 단위 테스트로는 나오지 않는 종류입니다.

이전 릴리스: [v0.23.0](docs/releases/v0.23.0.md) · [v0.22.0](docs/releases/v0.22.0.md) · [v0.21.0](docs/releases/v0.21.0.md) · [v0.20.0](docs/releases/v0.20.0.md) · [v0.19.0](docs/releases/v0.19.0.md) · [v0.18.0](docs/releases/v0.18.0.md) · [v0.17.0](docs/releases/v0.17.0.md) · [v0.16.0](docs/releases/v0.16.0.md) · [v0.15.0](docs/releases/v0.15.0.md) · [v0.14.0](docs/releases/v0.14.0.md) · [v0.13.0](docs/releases/v0.13.0.md) · [v0.12.0](docs/releases/v0.12.0.md) · [v0.11.0](docs/releases/v0.11.0.md) · [v0.10.0](docs/releases/v0.10.0.md) · [v0.9.0](docs/releases/v0.9.0.md) · [v0.8.1](docs/releases/v0.8.1.md)
