...
- **공유·변경 재검증**: 멤버 목록·공간 내보내기뿐 아니라 댓글 작성 transaction도 현재 멤버십을 끝까지 잠가, 권한 회수와 겹쳐도 이전 권한으로 본문·이벤트·webhook을 만들지 않습니다. 권한 회수 뒤의 댓글 해결·삭제는 terminal Problem Details로 종료해 오프라인 큐의 뒤 작업을 막지 않습니다.
