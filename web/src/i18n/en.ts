...
export const en: Dictionary = {
  ...
  '{count}개의 생각과 {links}개의 연결, {lines}개의 갈래를 되살렸습니다.':
    'Restored {count} thoughts, {links} connections and {lines} lines of thinking.',
  ...
  '{date}까지만 동작합니다': 'Works until {date}',
  '마지막 사용 {date}': 'Last used {date}',
  '아직 사용된 적 없음': 'Never used',
  '검토 대기': 'Awaiting review',
  승인됨: 'Approved',
  반려됨: 'Rejected',
  '이름을 확인할 수 없는 대상': 'Target no longer available',
  채택됨: 'Kept',
  숨김: 'Hidden',
  ...
  '왜 이었는지 적기': 'Say why',
  '왜 이었는지 고치기': 'Edit why',
  '연결 이유가 너무 깁니다': 'That reason is too long',
  ...
  '등록된 웹훅이 없습니다.': 'No webhooks are registered.',
  웹훅: 'Webhook',
  주인: 'Owner',
  '보내는 곳': 'Destination',
  '연속 실패': 'Consecutive failures',
  '최근 24시간 실패': 'Failed in last 24h',
  '마지막 전송': 'Last delivered',
  멈춤: 'Paused',
  멈추기: 'Pause',
  없음: 'None',
  '웹훅 목록을 불러오지 못했습니다.': 'Could not load the webhooks.',
  '웹훅을 멈추지 못했습니다.': 'Could not pause the webhook.',
  '웹훅 전송을 멈췄습니다.': 'Deliveries paused.',
  '“{name}” 웹훅 전송을 멈춥니다. 설정은 그대로 남고 주인이 다시 켤 수 있습니다.':
    'Pause deliveries for “{name}”. The configuration stays and its owner can turn it back on.',

  '공간과 참여자': 'Spaces and members',
  '떠난 사람이 소유한 공간만': 'Only spaces owned by someone who has left',
  '떠난 사람이 소유한 공간이 없습니다.': 'No space is owned by someone who has left.',
  '공간이 없습니다.': 'There are no spaces.',
  '새로 고침': 'Refresh',
  소유자: 'Owner',
  참여자: 'Members',
  생각: 'Thoughts',
  '소유자 넘기기': 'Hand over',
  '사람 고르기': 'Choose a person',
  넘기기: 'Hand over',
  '개인 공간': 'Personal space',
  수집함: 'Inbox',
  비활성: 'Inactive',
  '불러오는 중…': 'Loading…',
  '공간 목록을 불러오지 못했습니다.': 'Could not load the spaces.',
  '공간 참여자를 불러오지 못했습니다.': 'Could not load the members of this space.',
  '공간 소유자를 바꾸지 못했습니다.': 'Could not change the owner of this space.',
  '“{space}”의 소유자를 {user}(으)로 바꿉니다. 계속할까요?': 'Hand “{space}” over to {user}. Continue?',
  '소유자를 바꿨습니다. 이전 소유자는 관리 권한으로 남았습니다.':
    'Owner changed. The previous owner remains with manage permission.',
  '소유자를 바꿨습니다. 이전 소유자는 비활성이라 접근 권한을 남기지 않았습니다.':
    'Owner changed. The previous owner is deactivated, so no access was kept.',
  '감사 로그를 불러오지 못했습니다.': 'Could not load the audit log.',
  '아이디 또는 system': 'username or system',
  '대상 ID': 'Target ID',
  '공간·메모·키의 ID': 'ID of a space, thought or key',
  찾기: 'Search',
  '조건 지우기': 'Clear filters',
  '이 조건에 맞는 기록이 없습니다. 기록이 없다는 뜻이지, 찾지 못했다는 뜻이 아닙니다.':
    'Nothing matches these filters. That means there is no such record, not that the search failed.',
  ...
  '생각의 갈래': 'Lines of thinking',
  '시도해 본 방향을 갈래로 묶어 두면, 접어 둔 생각이 나중에 현재 방침처럼 읽히지 않습니다.':
    'Group a direction you tried into a line, and a thought you set aside will not read as current policy later.',
  '새 갈래 이름': 'New line name',
  '갈래 메뉴': 'Line menu',
  '진행 중': 'Exploring',
  채택: 'Taken',
  '접어 둠': 'Set aside',
  ...
  '제목 없음': 'Untitled',
  실패: 'Failed',
  '만들지 못했습니다.': 'It could not be made.',
  'Ptium에서 만들기': 'Make it in Ptium',
  'Ptium에서 이어서 편집할 수 있습니다.': 'You can carry on editing it in Ptium.',
  'Ptium이 조정한 부분': 'What Ptium adjusted',
  '{count}개 제외': '{count} left out',
  '구성을 만드는 중입니다…': 'Working out the talk…',
  '다시 구성': 'Rebuild',
  닫기: 'Close',
  '레이아웃 미확인': 'Layout unchecked',
  '레이아웃은 만든 뒤에 Ptium이 확인합니다.': 'Ptium checks the layout once the deck exists.',
  맞섬: 'Conflict',
  '발표 구성을 만들지 못했습니다.': 'Could not work out the talk.',
  '발표 자료를 만들었습니다.': 'The deck is made.',
  '발표 자료를 만들지 못했습니다.': 'Could not make the deck.',
  '발표로 만들 생각이 없습니다.': 'There is nothing here to present.',
  '발표로 만들기': 'Make a talk',
  '분석에서 제외한 생각도 넣기': 'Include thoughts held back from analysis',
  '분석에서 제외한 생각입니다. 위 스위치로 넣을 수 있습니다.':
    'Thoughts held back from analysis. The switch above puts them in.',
  '생각 {count}개': '{count} thoughts',
  '서로 어긋난다고 표시해 둔 두 생각입니다.': 'Two thoughts you recorded as contradicting each other.',
  '선택한 생각만 ({count}개)': 'Only the selected thoughts ({count})',
  '슬라이드 {count}장': '{count} slides',
  '이 공간을 발표 자료로': 'Turn this space into a talk',
  제목: 'Title',
  ...
  '접어 두기': 'Set aside',
  '갈래만 지우기 (생각은 남습니다)': 'Remove the line only (the thoughts stay)',
  '왜 이 방향으로 정했는지 적어 주세요.': 'Say why you took this direction.',
  '왜 접어 두는지 적어 주세요. 이유가 없으면 나중에 결정만 남고 까닭은 사라집니다.':
    'Say why you are setting it aside. Without a reason, the decision survives and what it was for does not.',
  '갈래를 정리하는 이유': 'Why this line is being resolved',
  '이유: {reason}': 'Reason: {reason}',
  '갈래를 만들 수 없습니다.': 'Could not create the line.',
  ...
  '그 다음 아래 임베딩 Gateway 주소에 http://embeddings:11434 을, 임베딩 모델에 bge-m3 을 넣고 저장한 뒤 다시 측정하세요. 채팅 모델 주소는 그대로 두면 됩니다. 후보 모델 비교는 docs/ADMIN_GUIDE.md에 있습니다.':
    'Then put http://embeddings:11434 in the embedding gateway URL below and bge-m3 in the embedding model, save, and measure again. Leave the chat model address as it is. Candidate models are compared in docs/ADMIN_GUIDE.md.',
